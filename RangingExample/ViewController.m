...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [ParseCheck CheckRSSIInParse:nearable.identifier];
...
+(void)RecieveParseDetails:(NSString *)locationName
{
    ...
    {
        NSLog(@"Location name recieved from parse and ready for display is");
        NSLog(locationName);
    }
    else
    {
        NSLog(@"Location name wasn't recieved from parse and isn't ready for display is");
    }
}
